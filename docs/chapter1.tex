...
single-trial wall-clock deltas are noisy enough, due to the machine noise 
ie. CPU load, memory pressure, background processes ect. that they are interpreted 
