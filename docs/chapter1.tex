...
The main limitations are single-zkVM scope, mostly single-trial headline
measurements, and incomplete per-target commit hashes in artifact JSON.
Chapter~12 explains their impact, and Chapter~13 prioritizes mitigation work.
