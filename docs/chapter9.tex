...
per benchmark target. In authenticated mode, encryption and tag generation stay
inside the guest so the proof binds both outputs to the same deterministic
execution.
