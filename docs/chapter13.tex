...
\begin{enumerate}
\item \textbf{Run a fully commit-locked multi-trial campaign (\(N \geq 5\)).}
This would convert directional inserts into statistically stronger headline
claims and close the main reproducibility gap. The output should include
variability bands, outlier notes, and regenerated figures from the same locked
commit.
...
credibility of every quantitative chapter at once.
...
\hline
Single-trial evidence & Commit-locked \(N \geq 5\) rerun & Highest impact on
confidence in all quantitative chapters \\
