...
\caption{AES-CTR median total time versus block count from the report benchmark run. Markers show the four measured block sizes only; no interpolation trend is implied.}
