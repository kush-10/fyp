...
This chapter maps the design decisions from Chapters 6 and 7 to concrete
...
rule from Chapter~7 so encryption and tag output remain part of one proved
execution.
...
runs the Chapter~7 verify-before-decrypt self-check, and commits outputs to the
...
In authenticated mode, host-side checks follow the Chapter~7 authentication
...
The 1--16 block CTR trace-rounding sweep used in Chapter 10 is run with:
