...
\begin{itemize}
\item \textbf{AES-192,} a standardized block-cipher baseline
...
MPC/ZK-oriented settings \cite{albrecht2015ciphers}.
\end{itemize}
...
\centering
\reporttablesetup
\begin{tabularx}{\textwidth}{@{}P{0.17\textwidth}LLL@{}}
\hline
...
& Benchmark LowMC rather than assume it wins \\
...
harness and artifact-backed comparisons \\
...
Table~\ref{tab:literature-to-design} also explains why later chapters use
measurements as decision evidence instead of treating the literature review as a
direct ranking. The literature
...
in Chapter 9's proof-output challenge game;
