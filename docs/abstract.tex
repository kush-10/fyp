...
block size; wall-clock total-time deltas remain small enough to require cautious
interpretation. These results are therefore reported with explicit statistical
