...
cipher benchmarking for AES-128, Salsa20, and LowMC, all measured through a
...
The final implemented system path is authenticated AES-128 in the zkVM:
AES-128-CTR encryption combined with Encrypt-then-MAC using HMAC-SHA256-192. The
construction authenticates a domain-separated, length-prefixed frame containing
AAD, IV/nonce, and ciphertext, and the verification path checks the tag before
decryption.
