...
\cite{cryptoag2020,zetter2020}. More narrowly, the Dual EC DRBG standardisation
controversy illustrates how a standardised cryptographic component can embed
hard-to-audit design choices \cite{bernstein2015dualec}. These examples motivate
independently verifiable cryptographic systems. A zkVM provides one layer of
verifiability: a proof shows that the fixed, inspectable program ran correctly,
so the executor cannot substitute a weakened cipher without changing the program
...
Chapter~5 evaluates the AES/LowMC primitive choice, and Chapter~10 evaluates the
...
formal-reduction depth. Chapter~11 explains their impact, and Chapter~13
