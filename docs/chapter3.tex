...
The report benchmark campaign uses \(N=1\) per target to cover the full set of
cipher and mode-family comparisons within dissertation compute/time limits,
especially for long-running LowMC proving jobs.
