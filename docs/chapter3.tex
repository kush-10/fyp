...
The benchmarkable target set developed during the project consists of:
...
The latest commit-locked headline main matrix is narrower than the full
development target set: it includes \texttt{aes-r0},
\texttt{lowmc-r0-optimised}, and the matched CTR and CTR+HMAC target families.
Historical targets such as \texttt{salsa-r0}, \texttt{lowmc-r0}, and
\texttt{aes-r0-optimised} remain supporting evidence unless a later chapter
explicitly ties them to a latest report run.
