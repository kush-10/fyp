...
step because the tag and encryption is part of the statement being proved. The verifier
should be able to interpret a receipt as evidence that the fixed guest image encrypted
