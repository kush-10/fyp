...
matched total-time deltas are not statistically significant after correction.
\end{itemize}
...
explicit scope decisions --- most notably single-host headline runs and older
single-trial supporting snapshots --- which themselves became part of the reported
methodology rather than hidden limitations.
